 ...
 */
export function showNotification(message: string, type: 'info' | 'success' | 'error' = 'info', duration: number = 5000): void { 
 ...
 */
export function showUndoableNotification(message: string, onUndoCallback: () => void, duration: number = 7000): void {
    const notification = document.createElement('div');
